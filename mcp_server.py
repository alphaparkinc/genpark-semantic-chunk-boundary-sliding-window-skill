"""
MCP Server for genpark-semantic-chunk-boundary-sliding-window-skill
...
chunker = SemanticSlidingWindowChunkerClient()
...
def handle_request(req):
    ...
    if method == "tools/list":
        return {
            ...
            "result": {
                "tools": [
                    {
                        "name": "chunk_document",
                        "description": "Partition text into sentence-aware sliding window chunks.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
                                "text": {"type": "string"},
        ...
        if tool_name == "chunk_document":
            res = chunker.chunk_text(args["text"])
            return {
                "jsonrpc": "2.0",
                "id": req_id,
                "result": {
